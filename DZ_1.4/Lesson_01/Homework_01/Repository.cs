...
namespace Homework_01
{
    ...
    class Repository
    {
        ...
        /// <summary>
        /// Метод увольняющий работников
        /// </summary>
        /// <param name="countWorker">Кол-во работников, которых нужно уволить</param>
        public void DeleteWorker(int countWorker)
        {
            this.Workers.RemoveRange(0, countWorker);
        }
    }
}
